    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangke !=null){
            ...
            //级联表 公寓
            //级联表
            FangwuEntity fangwu = fangwuService.selectById(fangke.getFangwuId());
            if(fangwu != null){
    ...
    */
    ...
    public R save(@RequestBody FangkeEntity fangke, HttpServletRequest request){
        ...
        Wrapper<FangkeEntity> queryWrapper = new EntityWrapper<FangkeEntity>()
            .eq("fangwu_id", fangke.getFangwuId())
...
//        else if("学生".equals(role))
//            fangke.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(fangke.getFangkeContent()) || "null".equals(fangke.getFangkeContent())){
                fangke.setFangkeContent(null);
        }
...
//                            fangkeEntity.setFangwuId(Integer.valueOf(data.get(0)));   //公寓 要改的
//                            fangkeEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
...
//                            fangkeEntity.setLikaiTime(sdf.parse(data.get(0)));          //离开时间 要改的
