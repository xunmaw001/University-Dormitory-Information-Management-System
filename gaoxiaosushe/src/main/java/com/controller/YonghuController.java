...
//                            yonghuEntity.setYonghuXingge(data.get(0));                    //性格 要改的
//                            yonghuEntity.setYonghuRushuishijian(data.get(0));                    //入睡时间 要改的
//                            yonghuEntity.setYonghuQichuangshijian(data.get(0));                    //起床时间 要改的
