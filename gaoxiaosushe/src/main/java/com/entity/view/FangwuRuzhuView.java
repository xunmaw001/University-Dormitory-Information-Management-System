...
public class FangwuRuzhuView extends FangwuRuzhuEntity implements Serializable {
	...
	public FangwuRuzhuView() {

	}

	public FangwuRuzhuView(FangwuRuzhuEntity fangwuRuzhuEntity) {
		try {
			BeanUtils.copyProperties(this, fangwuRuzhuEntity);
