...
public class FangwuTuisuView extends FangwuTuisuEntity implements Serializable {
	...
	*/
	...
	private String fangwuTuisuYesnoValue;
	...
	public FangwuTuisuView() {

	}

	public FangwuTuisuView(FangwuTuisuEntity fangwuTuisuEntity) {
		try {
			BeanUtils.copyProperties(this, fangwuTuisuEntity);
	...
	* 获取： 申请状态的值
	*/
	public String getFangwuTuisuYesnoValue() {
		return fangwuTuisuYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setFangwuTuisuYesnoValue(String fangwuTuisuYesnoValue) {
		this.fangwuTuisuYesnoValue = fangwuTuisuYesnoValue;
	}
	...
	public String toString() {
		return "FangwuTuisuView{" +
			", fangwuTuisuYesnoValue=" + fangwuTuisuYesnoValue +
