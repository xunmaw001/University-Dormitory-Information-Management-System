    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="留言编号" prop="liuyanUuidNumber">
                       <el-input v-model="ruleForm.liuyanUuidNumber"
                                 placeholder="留言编号" clearable  :readonly="ro.liuyanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="留言编号" prop="liuyanUuidNumber">
                           <el-input v-model="ruleForm.liuyanUuidNumber"
                                     placeholder="留言编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.liuyanFile" label="附件" prop="liuyanFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.liuyanFile?$base.url+ruleForm.liuyanFile:''"
                                @change="liuyanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.liuyanFile" label="附件" prop="liuyanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.liuyanFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.liuyanHuifuContent"  label="回复内容" prop="liuyanHuifuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.liuyanHuifuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.liuyanHuifuContent" label="回复内容" prop="liuyanHuifuContent">
                            <span v-html="ruleForm.liuyanHuifuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    liuyanUuidNumber: new Date().getTime(),
                    liuyanName: '',
                    liuyanFile: '',
                    liuyanTypes: '',
                    liuyanContent: '',
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.liuyanContent = _this.ruleForm.liuyanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.liuyanHuifuContent = _this.ruleForm.liuyanHuifuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.liuyanContent = this.ruleForm.liuyanContent.replaceAll(this.$base.url,"");
                        this.ruleForm.liuyanHuifuContent = this.ruleForm.liuyanHuifuContent.replaceAll(this.$base.url,"");
                        this.$http({
