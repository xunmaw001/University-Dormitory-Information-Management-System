    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校宿舍信息管理系统小程序注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="工号" class="input" v-if="tableName=='susheguanliyuan'">
                                <el-input v-model="ruleForm.susheguanliyuanUuidNumber" autocomplete="off" placeholder="工号"  />
                           </el-form-item>
                        -->
                        ...
                        <el-form-item label="宿舍管理员身份证号" class="input" v-if="tableName=='susheguanliyuan'">
                            <el-input v-model="ruleForm.susheguanliyuanIdNumber" autocomplete="off" placeholder="宿舍管理员身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="susheguanliyuanPhotoFlag">
                            </el-form-item>
                            <el-form-item label="宿舍管理员头像" class="input" v-if="tableName=='susheguanliyuan'">
                                    <file-upload
                                        tip="点击上传宿舍管理员头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.susheguanliyuanPhoto?$base.url+ruleForm.susheguanliyuanPhoto:''"
                                        @change="susheguanliyuanPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="宿舍管理员邮箱" class="input" v-if="tableName=='susheguanliyuan'">
                            <el-input v-model="ruleForm.susheguanliyuanEmail" autocomplete="off" placeholder="宿舍管理员邮箱"  />
                        </el-form-item>
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='susheguanliyuan'">
                        ...
                        -->
                        <!--
                            <el-form-item label="性格" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuXingge" autocomplete="off" placeholder="性格"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="入睡时间" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuRushuishijian" autocomplete="off" placeholder="入睡时间"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="起床时间" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuQichuangshijian" autocomplete="off" placeholder="起床时间"  />
                           </el-form-item>
                        -->
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                susheguanliyuanPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            susheguanliyuanPhotoUploadChange(fileUrls) {
               this.ruleForm.susheguanliyuanPhoto = fileUrls;
                if(this.susheguanliyuanPhotoFlag){
                    this.susheguanliyuanPhotoFlag=false;
                }else{
                    this.susheguanliyuanPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // susheguanliyuan 中的 工号 判空处理
                            // if('susheguanliyuan' == this.tableName && (this.ruleForm.susheguanliyuanUuidNumber== null ||this.ruleForm.susheguanliyuanUuidNumber== "")){
                            //     this.$message.error("工号不能为空");
                            //     return
                            // }
                            if((!this.ruleForm.susheguanliyuanName)&& 'susheguanliyuan'==this.tableName){
                            ...
                            if((!this.ruleForm.susheguanliyuanIdNumber)&& 'susheguanliyuan'==this.tableName){
                                this.$message.error('宿舍管理员身份证号不能为空');
                                return
                            }
                            // susheguanliyuan 中的 宿舍管理员头像 判空处理
                            // if('susheguanliyuan' == this.tableName && (this.ruleForm.susheguanliyuanPhoto== null ||this.ruleForm.susheguanliyuanPhoto== "")){
                            ...
                            // susheguanliyuan 中的 账户状态 判空处理
                            // if('susheguanliyuan' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
                            // susheguanliyuan 中的 创建时间 判空处理
                            // if('susheguanliyuan' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            ...
                            // }
                            // yonghu 中的 性格 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuXingge== null ||this.ruleForm.yonghuXingge== "")){
                            //     this.$message.error("性格不能为空");
                            //     return
                            // }
                            // yonghu 中的 入睡时间 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuRushuishijian== null ||this.ruleForm.yonghuRushuishijian== "")){
                            //     this.$message.error("入睡时间不能为空");
                            //     return
                            // }
                            // yonghu 中的 起床时间 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuQichuangshijian== null ||this.ruleForm.yonghuQichuangshijian== "")){
                            //     this.$message.error("起床时间不能为空");
                            //     return
                            // }
                            ...
                            // }
                            // yonghu 中的 学院 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.xueyuanTypes== null ||this.ruleForm.xueyuanTypes== "")){
                            //     this.$message.error("学院不能为空");
                            //     return
                            // }
                            // yonghu 中的 专业 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.zhuanyeTypes== null ||this.ruleForm.zhuanyeTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/gaoxiaosushe/img/back-img-bg.jpg);
