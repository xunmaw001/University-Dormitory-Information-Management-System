               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="susheguanliyuanUuidNumber">
                       <el-input v-model="ruleForm.susheguanliyuanUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.susheguanliyuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宿舍管理员身份证号" prop="susheguanliyuanIdNumber">
                       <el-input v-model="ruleForm.susheguanliyuanIdNumber"
                                 placeholder="宿舍管理员身份证号" clearable  :readonly="ro.susheguanliyuanIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宿舍管理员邮箱" prop="susheguanliyuanEmail">
                       <el-input v-model="ruleForm.susheguanliyuanEmail"
                                 placeholder="宿舍管理员邮箱" clearable  :readonly="ro.susheguanliyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    susheguanliyuanUuidNumber: new Date().getTime(),
                    susheguanliyuanName: '',
                ...
                rules: {
                   ...
                   susheguanliyuanIdNumber: [
                              { required: true, message: '宿舍管理员身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '宿舍管理员身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   susheguanliyuanPhoto: [
                   ...
                   susheguanliyuanEmail: [
                              { required: true, message: '宿舍管理员邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '宿舍管理员邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                   jinyongTypes: [
