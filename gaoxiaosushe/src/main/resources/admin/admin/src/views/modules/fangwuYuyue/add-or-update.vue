    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="fangwuYuyueUuidNumber">
                       <el-input v-model="ruleForm.fangwuYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.fangwuYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="fangwuYuyueUuidNumber">
                           <el-input v-model="ruleForm.fangwuYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="fangwuYuyueText">
                        <el-input type="textarea"  :readonly="ro.fangwuYuyueText" v-model="ruleForm.fangwuYuyueText" placeholder="申请理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuYuyueText" label="申请理由" prop="fangwuYuyueText">
                            <span v-html="ruleForm.fangwuYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuYuyueYesnoTypes" label="申请状态" prop="fangwuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.fangwuYuyueYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuYuyueYesnoText" label="审核回复" prop="fangwuYuyueYesnoText">
                        <span v-html="ruleForm.fangwuYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.fangwuYuyueShenheTime" label="审核时间" prop="fangwuYuyueShenheTime">
                        <span v-html="ruleForm.fangwuYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    fangwuYuyueUuidNumber: new Date().getTime(),
                    fangwuId: '',
                    yonghuId: '',
                    fangwuYuyueText: '',
                    insertTime: '',
                    fangwuYuyueYesnoTypes: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '申请入住时间不能为空', trigger: 'blur' },
                          ],
                   fangwuYuyueYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fangwuYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fangwuYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
