    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修标题" prop="baoxiuName">
                       <el-input v-model="ruleForm.baoxiuName"
                                 placeholder="报修标题" clearable  :readonly="ro.baoxiuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修标题" prop="baoxiuName">
                           <el-input v-model="ruleForm.baoxiuName"
                                     placeholder="报修标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.baoxiuFile" label="附件" prop="baoxiuFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.baoxiuFile?$base.url+ruleForm.baoxiuFile:''"
                                @change="baoxiuFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.baoxiuFile" label="附件" prop="baoxiuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.baoxiuFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.baoxiuContent"  label="报修内容" prop="baoxiuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.baoxiuContent" label="报修内容" prop="baoxiuContent">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.baoxiuHuifuContent"  label="回复内容" prop="baoxiuHuifuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.baoxiuHuifuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.baoxiuHuifuContent" label="回复内容" prop="baoxiuHuifuContent">
                            <span v-html="ruleForm.baoxiuHuifuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                  ...
                  this.ro.baoxiuUuidNumber=true
                  this.ro.baoxiuName=true
                  this.ro.baoxiuFile=true
                  this.ro.baoxiuTypes=true
                  this.ro.baoxiuContent=true
                  this.ro.insertTime=true
                  this.ro.baoxiuZhuangtaiTypes=true
                  this.ro.baoxiuHuifuContent=false
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.baoxiuHuifuContent = _this.ruleForm.baoxiuHuifuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        this.ruleForm.baoxiuHuifuContent = this.ruleForm.baoxiuHuifuContent.replaceAll(this.$base.url,"");
                        this.$http({
            ...
            //图片
            baoxiuFileUploadChange(fileUrls){
                this.ruleForm.baoxiuFile = fileUrls;
                this.addEditUploadStyleChange()
            },
