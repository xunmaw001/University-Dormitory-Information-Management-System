               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="性格" prop="yonghuXingge">
                       <el-input v-model="ruleForm.yonghuXingge"
                                 placeholder="性格" clearable  :readonly="ro.yonghuXingge"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入睡时间" prop="yonghuRushuishijian">
                       <el-input v-model="ruleForm.yonghuRushuishijian"
                                 placeholder="入睡时间" clearable  :readonly="ro.yonghuRushuishijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="起床时间" prop="yonghuQichuangshijian">
                       <el-input v-model="ruleForm.yonghuQichuangshijian"
                                 placeholder="起床时间" clearable  :readonly="ro.yonghuQichuangshijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuXingge: [
                              { required: true, message: '性格不能为空', trigger: 'blur' },
                          ],
                   yonghuRushuishijian: [
