                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaosushe/upload/yonghuMuBan.xls"
                        >批量导入学生数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   ...
                                   label="性格">
                        <template slot-scope="scope">
                            {{scope.row.yonghuXingge}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="yonghuRushuishijian"
                                   header-align="center"
                                   label="入睡时间">
                        <template slot-scope="scope">
                            {{scope.row.yonghuRushuishijian}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="yonghuQichuangshijian"
                                   header-align="center"
                                   label="起床时间">
                        <template slot-scope="scope">
                            {{scope.row.yonghuQichuangshijian}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="sexTypes"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                yonghuPhoto : null,
                yonghuXingge : null,
                yonghuRushuishijian : null,
                yonghuQichuangshijian : null,
                sexTypes : null,
                yonghuEmail : null,
                newMoney : null,
                xueyuanTypes : null,
