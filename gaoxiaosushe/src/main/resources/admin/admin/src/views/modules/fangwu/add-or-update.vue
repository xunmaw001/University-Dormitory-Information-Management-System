        ...
        <el-form
            ...
            <input id="susheguanliyuanId" name="susheguanliyuanId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公寓编号" prop="fangwuUuidNumber">
                       <el-input v-model="ruleForm.fangwuUuidNumber"
                                 placeholder="公寓编号" clearable  :readonly="ro.fangwuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="公寓类型" prop="fangwuTypes">
                        <el-select v-model="ruleForm.fangwuTypes" :disabled="ro.fangwuTypes" placeholder="请选择公寓类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房租/月" prop="fangwuNewMoney">
                       <el-input v-model="ruleForm.fangwuNewMoney"
                                 placeholder="房租/月" clearable  :readonly="ro.fangwuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="房租/月" prop="fangwuNewMoney">
                           <el-input v-model="ruleForm.fangwuNewMoney"
                                     placeholder="房租/月" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="限制人数" prop="fangwuRenshu">
                       <el-input v-model="ruleForm.fangwuRenshu"
                                 placeholder="限制人数" clearable  :readonly="ro.fangwuRenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="已住人数" prop="fangwuYizhurenshu">
                       <el-input v-model="ruleForm.fangwuYizhurenshu"
                                 placeholder="已住人数" clearable  :readonly="ro.fangwuYizhurenshu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.fangwuContent"  label="公寓介绍" prop="fangwuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuContent" label="公寓介绍" prop="fangwuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   fangwuPhoto: [
                              { required: true, message: '公寓照片不能为空', trigger: 'blur' },
                          ],
                   fangwuAddress: [
                              { required: true, message: '房屋位置不能为空', trigger: 'blur' },
                          ],
                   fangwuTypes: [
                              { required: true, message: '公寓类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   fangwuNewMoney: [
                              { required: true, message: '房租/月不能为空', trigger: 'blur' },
                   ...
                   fangwuContent: [
                              { required: true, message: '公寓介绍不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
