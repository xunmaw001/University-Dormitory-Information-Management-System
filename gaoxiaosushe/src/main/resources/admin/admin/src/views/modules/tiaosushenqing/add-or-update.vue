    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="fangwuId" name="fangwuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="调宿申请编号" prop="tiaosushenqingUuidNumber">
                       <el-input v-model="ruleForm.tiaosushenqingUuidNumber"
                                 placeholder="调宿申请编号" clearable  :readonly="ro.tiaosushenqingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="调宿申请编号" prop="tiaosushenqingUuidNumber">
                           <el-input v-model="ruleForm.tiaosushenqingUuidNumber"
                                     placeholder="调宿申请编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请标题" prop="tiaosushenqingName">
                       <el-input v-model="ruleForm.tiaosushenqingName"
                                 placeholder="申请标题" clearable  :readonly="ro.tiaosushenqingName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="申请标题" prop="tiaosushenqingName">
                           <el-input v-model="ruleForm.tiaosushenqingName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.tiaosushenqingFile" label="申请附件" prop="tiaosushenqingFile">
                        <file-upload
                                tip="点击上传申请附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.tiaosushenqingFile?$base.url+ruleForm.tiaosushenqingFile:''"
                                @change="tiaosushenqingFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.tiaosushenqingFile" label="申请附件" prop="tiaosushenqingFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.tiaosushenqingFile"  >申请附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="调宿申请类型" prop="tiaosushenqingTypes">
                        <el-select v-model="ruleForm.tiaosushenqingTypes" :disabled="ro.tiaosushenqingTypes" placeholder="请选择调宿申请类型">
                            <el-option
                                v-for="(item,index) in tiaosushenqingTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="调宿申请类型" prop="tiaosushenqingValue">
                        <el-input v-model="ruleForm.tiaosushenqingValue"
                            placeholder="调宿申请类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原宿舍名称" prop="tiaosushenqingYuanName">
                       <el-input v-model="ruleForm.tiaosushenqingYuanName"
                                 placeholder="原宿舍名称" clearable  :readonly="ro.tiaosushenqingYuanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="原宿舍名称" prop="tiaosushenqingYuanName">
                           <el-input v-model="ruleForm.tiaosushenqingYuanName"
                                     placeholder="原宿舍名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原宿舍位置" prop="tiaosushenqingYuanAddress">
                       <el-input v-model="ruleForm.tiaosushenqingYuanAddress"
                                 placeholder="原宿舍位置" clearable  :readonly="ro.tiaosushenqingYuanAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="原宿舍位置" prop="tiaosushenqingYuanAddress">
                           <el-input v-model="ruleForm.tiaosushenqingYuanAddress"
                                     placeholder="原宿舍位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.tiaosushenqingContent"  label="申请缘由" prop="tiaosushenqingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.tiaosushenqingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tiaosushenqingContent" label="申请缘由" prop="tiaosushenqingContent">
                            <span v-html="ruleForm.tiaosushenqingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tiaosushenqingYesnoTypes" label="申请状态" prop="tiaosushenqingYesnoTypes">
                        <el-input v-model="ruleForm.tiaosushenqingYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tiaosushenqingYesnoText" label="审核意见" prop="tiaosushenqingYesnoText">
                        <span v-html="ruleForm.tiaosushenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tiaosushenqingShenheTime" label="审核时间" prop="tiaosushenqingShenheTime">
                        <span v-html="ruleForm.tiaosushenqingShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    yonghuId: '',
                    fangwuId: '',
                    tiaosushenqingUuidNumber: new Date().getTime(),
                    tiaosushenqingName: '',
                    tiaosushenqingFile: '',
                    tiaosushenqingTypes: '',
                ...
                rules: {
                   ...
                   tiaosushenqingUuidNumber: [
                              { required: true, message: '调宿申请编号不能为空', trigger: 'blur' },
                          ],
                   tiaosushenqingName: [
                   ...
                   tiaosushenqingTypes: [
                              { required: true, message: '调宿申请类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tiaosushenqingYuanName: [
                              { required: true, message: '原宿舍名称不能为空', trigger: 'blur' },
                          ],
                   tiaosushenqingYuanAddress: [
                              { required: true, message: '原宿舍位置不能为空', trigger: 'blur' },
                          ],
                   tiaosushenqingContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tiaosushenqing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tiaosushenqingTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tiaosushenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tiaosushenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.tiaosushenqingContent = _this.ruleForm.tiaosushenqingContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.tiaosushenqingContent = this.ruleForm.tiaosushenqingContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`tiaosushenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tiaosushenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            tiaosushenqingFileUploadChange(fileUrls){
                this.ruleForm.tiaosushenqingFile = fileUrls;
                this.addEditUploadStyleChange()
            },
