        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaosushe/upload/liuyanMuBan.xls"
                        >批量导入留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('liuyan','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="liuyanUuidNumber"
                                   header-align="center"
                                   label="留言编号">
                        <template slot-scope="scope">
                            {{scope.row.liuyanUuidNumber}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="liuyanFile"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.liuyanFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.liuyanFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                id : null,
                yonghuId : null,
                liuyanUuidNumber : null,
                liuyanName : null,
                liuyanFile : null,
                liuyanTypes : null,
                liuyanContent : null,
                insertTime : null,
                liuyanHuifuContent : null,
                updateTime : null,
                createTime : null,
            },
            dataList: [],
