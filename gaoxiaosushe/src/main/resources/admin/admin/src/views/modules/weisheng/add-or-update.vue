    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="fangwuId" name="fangwuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="卫生编号" prop="weishengUuidNumber">
                       <el-input v-model="ruleForm.weishengUuidNumber"
                                 placeholder="卫生编号" clearable  :readonly="ro.weishengUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="卫生编号" prop="weishengUuidNumber">
                           <el-input v-model="ruleForm.weishengUuidNumber"
                                     placeholder="卫生编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.weishengPhoto" label="卫生照片" prop="weishengPhoto">
                        <file-upload
                            tip="点击上传卫生照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.weishengPhoto?$base.url+ruleForm.weishengPhoto:''"
                            @change="weishengPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weishengPhoto" label="卫生照片" prop="weishengPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.weishengPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="卫生状况" prop="weishengTypes">
                        <el-select v-model="ruleForm.weishengTypes" :disabled="ro.weishengTypes" placeholder="请选择卫生状况">
                            <el-option
                                v-for="(item,index) in weishengTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="卫生状况" prop="weishengValue">
                        <el-input v-model="ruleForm.weishengValue"
                            placeholder="卫生状况" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="得分" prop="weishengPrice">
                       <el-input v-model="ruleForm.weishengPrice"
                                 placeholder="得分" clearable  :readonly="ro.weishengPrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="得分" prop="weishengPrice">
                           <el-input v-model="ruleForm.weishengPrice"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.weishengContent"  label="卫生备注" prop="weishengContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.weishengContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.weishengContent" label="卫生备注" prop="weishengContent">
                            <span v-html="ruleForm.weishengContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    susheguanliyuanId: '',
                    fangwuId: '',
                    weishengUuidNumber: new Date().getTime(),
                    weishengPhoto: '',
                    weishengTypes: '',
                    weishengPrice: '',
                    weishengContent: '',
                ...
                rules: {
                   ...
                   weishengUuidNumber: [
                              { required: true, message: '卫生编号不能为空', trigger: 'blur' },
                          ],
                   weishengPhoto: [
                              { required: true, message: '卫生照片不能为空', trigger: 'blur' },
                          ],
                   weishengTypes: [
                              { required: true, message: '卫生状况不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   weishengContent: [
                              { required: true, message: '卫生备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=weisheng_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.weishengTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.weishengContent = _this.ruleForm.weishengContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.weishengContent = this.ruleForm.weishengContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`weisheng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.weishengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            weishengPhotoUploadChange(fileUrls){
                this.ruleForm.weishengPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
