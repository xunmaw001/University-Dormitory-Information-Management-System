        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.fangkeContent"  label="来访事由" prop="fangkeContent">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.likaiTime"  class="input" label="离开时间" prop="likaiTime">
                        <el-date-picker
