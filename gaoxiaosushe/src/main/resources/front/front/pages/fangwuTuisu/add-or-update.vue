        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.fangwuTuisuUuidNumber" type="text" v-model="ruleForm.fangwuTuisuUuidNumber" placeholder="退宿编号"></input>
            </view>
            <view
                ...
                <textarea :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.fangwuTuisuText" v-model="ruleForm.fangwuTuisuText" placeholder="申请理由"/>
            </view>
            ...
            <view class="btn">
                <button
					...
					<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="fangwuTuisuShenheTimeConfirm"
                              ref="fangwuTuisuShenheTime" themeColor="#333333"></w-picker>
...
<script>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					fangwuTuisuUuidNumber: this.getUUID(),//数字
					fangwuId: '',
					yonghuId: '',
					fangwuTuisuText: '',
					insertTime: '',
					fangwuTuisuYesnoTypes: '',//数字
					fangwuTuisuYesnoValue: '',//数字对应的值
		...
		/*下拉框*/
			let fangwuTuisuYesnoTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'fangwu_tuisu_yesno_types',
            }
			let fangwuTuisuYesnoTypes = await this.$api.page(`dictionary`, fangwuTuisuYesnoTypesParams);
			this.fangwuTuisuYesnoTypesOptions = fangwuTuisuYesnoTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`fangwuTuisu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.fangwuTuisuId){
                this.ruleForm.fangwuTuisuId = options.fangwuTuisuId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            // 下拉变化
            fangwuTuisuYesnoTypesChange(e) {
                this.fangwuTuisuYesnoTypesIndex = e.target.value
                this.ruleForm.fangwuTuisuYesnoValue = this.fangwuTuisuYesnoTypesOptions[this.fangwuTuisuYesnoTypesIndex].indexName
                this.ruleForm.fangwuTuisuYesnoTypes = this.fangwuTuisuYesnoTypesOptions[this.fangwuTuisuYesnoTypesIndex].codeIndex
            },
            // styleChange() {
            // 	this.$nextTick(() => {
			...
			// 日期控件
			fangwuTuisuShenheTimeConfirm(val) {
                this.ruleForm.fangwuTuisuShenheTime = val.result;
                this.$forceUpdate();
            },
			// 日期控件
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.fangwuTuisuUuidNumber)) {
                    this.$utils.msg(`退宿编号不能为空`);
                    return
                }
				if ((!this.ruleForm.fangwuTuisuText)) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`fangwuTuisu`, this.ruleForm);
                } else {
                    await this.$api.save(`fangwuTuisu`, this.ruleForm);
                }
