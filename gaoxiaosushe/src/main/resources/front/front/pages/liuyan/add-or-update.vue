        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.liuyanUuidNumber" type="text" v-model="ruleForm.liuyanUuidNumber" placeholder="留言编号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">留言标题</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.liuyanName" type="text" v-model="ruleForm.liuyanName" placeholder="留言标题"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="liuyanFileTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">附件</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.liuyanFile" :src="baseUrl+ruleForm.liuyanFile" mode="aspectFill">
                        </image>
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">留言类型</view>
                    <picker @change="liuyanTypesChange" :value="liuyanTypesIndex" :range="liuyanTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.liuyanTypes?ruleForm.liuyanValue:"请选择留言类型"}}</view>
                    </picker>
                </view>
            <view
                ...
                <textarea :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.liuyanContent" v-model="ruleForm.liuyanContent" placeholder="留言内容"/>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let liuyanTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'liuyan_types',
            }
			let liuyanTypes = await this.$api.page(`dictionary`, liuyanTypesParams);
			this.liuyanTypesOptions = liuyanTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`liuyan`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.liuyanId){
                this.ruleForm.liuyanId = options.liuyanId;
            }
            // 跨表
            // this.styleChange()
        },
   ...
   //          }
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`liuyan`, this.ruleForm);
                } else {
                    await this.$api.save(`liuyan`, this.ruleForm);
                }
