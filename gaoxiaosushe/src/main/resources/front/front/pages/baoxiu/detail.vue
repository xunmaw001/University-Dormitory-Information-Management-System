		...
		export default {
			...
			methods: {
				...
				async init() {
					...
					this.detail.baoxiuHuifuContent = this.detail.baoxiuHuifuContent.replace("<img","<img  class=\"daxiao\"").replace("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
                                ...
                                // uni.setStorageSync('baoxiuId', _this.baoxiuId);
                                // _this.$utils.jump('/pages/baoxiuYuyue/add-or-update');
