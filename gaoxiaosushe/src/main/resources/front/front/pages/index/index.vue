...
<view class="title"
    ...
    <view
            :style='{"padding":"0 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"var(--publicSubColor)","color":"rgba(255, 255, 255, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0 0 0 8rpx","width":"50%","fontSize":"32rpx","lineHeight":"80rpx","borderStyle":"solid"}'>
    公寓展示
    </view>
    <text
            :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"var(--publicMainColor)","textAlign":"right","borderRadius":"0","borderWidth":"0","width":"50%","lineHeight":"80rpx","fontSize":"32rpx","borderStyle":"solid"}'
            @tap="onPageTap('fangwu')">查看更多
    </text>
</view>
<view class="list-box style1"
      :style='{"padding":"20rpx 24rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
    <view @tap="onDetailTap('fangwu',product.id)" v-for="(product,index) in fangwuList"
          :key="index" class="list-item"
          :style='{"padding":"40rpx 20rpx","boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 20rpx","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"1800rpx 1800rpx 0  0","borderWidth":"0 10rpx 20rpx","width":"48%","borderStyle":"solid","height":"auto"}'>
        <view
                :style='{"padding":"9rpx 20rpx","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"12rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"center","borderRadius":"20rpx","borderWidth":"0","width":"90%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="list-item-title hide1">{{product.fangwuName}}
        </view>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"50%","borderWidth":"0","width":"100%","borderStyle":"solid","height":"240rpx"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+product.fangwuPhoto"></image>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            this.fangwuList = fangwu.data.list
            this.fangwuList.forEach(function(item, index) {
