	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input :style='{"padding":"0 24rpx","boxShadow":"0 10rpx 0px rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"40rpx","borderWidth":"2rpx 2rpx 10rpx 2rpx","fontSize":"26rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
						v-model="searchForm.yonghuName" type="text" placeholder="学生姓名"></input>
		</view>
            ...
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                <view
                 ...
                 <view v-show="item.yonghuUuidNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">学号</text>
                 ...
                 <view v-show="item.yonghuPhone" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">学生手机号</text>
                 ...
                 <view v-show="item.yonghuIdNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">学生身份证号</text>
                     <text style="width: 70%">{{item.yonghuIdNumber}}</text>
                 </view>
                 <view v-show="item.yonghuXingge" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">性格</text>
                     <text style="width: 70%">{{item.yonghuXingge}}</text>
                 </view>
                 <view v-show="item.yonghuRushuishijian" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">入睡时间</text>
                     <text style="width: 70%">{{item.yonghuRushuishijian}}</text>
                 </view>
                 <view v-show="item.yonghuQichuangshijian" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">起床时间</text>
                     <text style="width: 70%">{{item.yonghuQichuangshijian}}</text>
                 </view>
                 ...
                 <view v-show="item.yonghuEmail" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">学生邮箱</text>
                 ...
                 <view v-show="item.xueyuanValue" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">学院</text>
                     <text style="width: 70%">{{item.xueyuanValue}}</text>
                 </view>
                 <view v-show="item.zhuanyeValue" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">专业</text>
                     <text style="width: 70%">{{item.zhuanyeValue}}</text>
                 </view>
		...
		async onShow() {
            ...
            _this.btnColor = _this.btnColor.sort(() => {
		  	...
		  	this.sexTypesList = sexTypes.data.list;
	   		...
	   		//当前表的 学院 字段 字典表查询方法
		  	let xueyuanTypes = await this.$api.page('dictionary', {
			 	 page: 1,
			  	limit: 100,
		  		dicCode:'xueyuan_types'
		  	});
		  	this.xueyuanTypesList = xueyuanTypes.data.list;
